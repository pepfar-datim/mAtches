describe("The Home Page", () => {
  ...
  it("does not allow you to add a new map with an existing name", () => {
    ...
    cy.get("#select-questionnaire")
      .click()
      .get(
        '[data-value="http://datim.org/fhir/Questionnaire/PLM-HIV-Questionnaire"]'
      )
      .click();

    cy.get("#addMapButton").should("be.disabled");
  });
