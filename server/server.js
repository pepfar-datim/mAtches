...
const { port, base: basePath } = config;

const DIST_DIR = path.join(__dirname, "../dist");
const HTML_FILE = path.join(DIST_DIR, basePath, "index.html");
const ERROR_FILE = path.join(DIST_DIR, basePath, "error.html");
...
app.post(
  `${basePath}api/maps/:id/upload/valueMap/:header`,
  api.validateValueMapPayload
);
